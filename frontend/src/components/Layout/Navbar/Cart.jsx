            ...
            >
                <Box width='25em' display='flex' flexDirection='column' p={2}>
                    ...
                    >
                        ...
                        <Typography variant='subtitle1' fontWeight='500' ml={2} mr='auto'>{props.user.cartItems} Items</Typography>
                        <IconButton
                            sx={{ mr: -1 }}
                            color='primary'
                        ...
                        {props.user.cart.map(item => (
                            <Box display='flex' alignItems='center' key={item.product._id} mt={2}>
                                <Box>
                                    ...
                                    <Typography sx={{ textAlign: 'center', my: '0.1em' }} variant='h6'>{item.quantity}</Typography>
                                    <IconButton
                                        color='tertiary'
                                        onClick={() => props.updateInCart(item.product._id, item.quantity - 1)}
